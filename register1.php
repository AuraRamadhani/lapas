...
if (isset($_POST['cek'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO tbsiswa (username, password)
               ...
               <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post" autocomplete="off">
                            ...
                            <input type="number" style="margin-bottom:10px;"  name="password" id="password" class="form-control" required>

                            <label for="text" style="margin-bottom: 12px;">Confirm NIS</label>
                            <input type="number" style="margin-bottom:10px;" name="cpassword" id="cpassword" class="form-control" required>
